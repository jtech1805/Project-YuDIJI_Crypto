...
export const SetupAnimation = () => {
  ...
  return (
    <div ref={ref} className="relative">
      <div
        className={`relative max-w-xl mx-auto glass rounded-2xl p-8 transition-shadow duration-500 ${
          started ? "glow-primary" : ""
        }`}
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <div className="font-mono text-[10px] text-muted-foreground tracking-widest">CONFIG / 01</div>
            <h3 className="text-xl font-semibold mt-1">Risk Monitor</h3>
          </div>
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between">
            <label className="font-mono text-[10px] text-muted-foreground tracking-widest">DROP THRESHOLD</label>
        ...
        <div className="mt-6 flex items-center justify-between p-4 rounded-lg bg-secondary/50 border border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium">AI Root Cause Analysis</div>
              <div className="font-mono text-[10px] text-muted-foreground">GPT-driven · adds ~80ms</div>
            </div>
          </div>
        ...
        {/* Start button */}
        <motion.button
          className={`mt-6 w-full py-3 rounded-lg font-mono text-sm tracking-wider transition-all ${
            started
        ...
        >
          {started ? "MONITOR ACTIVE ●" : "START MONITOR"}
        </motion.button>
