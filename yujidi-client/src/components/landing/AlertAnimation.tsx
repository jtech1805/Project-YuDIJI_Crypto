...
const fullText =
  "Analyzing order book depth... Massive sell wall detected on Binance tied to MT Gox wallet movement. Estimated 12,400 BTC inflow to exchange in last 4 minutes. Confidence: 94%.";
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-bear/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-semibold">Volatility Anomaly Detected</div>
            </div>
          </div>
        ...
        <div className="p-6 space-y-5">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <span className="font-mono text-[10px] text-muted-foreground tracking-widest">SENTIMENT</span>
              <span
          ...
          <div className="rounded-lg bg-primary/5 border border-primary/20 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-mono text-[10px] tracking-widest text-primary">AI ROOT CAUSE ANALYSIS</span>
            </div>
