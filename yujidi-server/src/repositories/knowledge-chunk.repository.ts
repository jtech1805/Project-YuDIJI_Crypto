...
const parse = (r: Record<string, any> | undefined): PersistedKnowledgeChunk | null => r && r.createdAt instanceof Date ? freezeClone({ identity: { chunkId: r.chunkId, chunkVersion: r.chunkVersion }, documentIdentity: r.documentIdentity, strategy: r.strategy, chunkType: r.chunkType, ordinal: r.ordinal, content: r.content, sourceSpan: r.sourceSpan, ...(r.parent ? { parent: r.parent } : {}), metadata: r.metadata, contentDigest: r.contentDigest, createdAt: r.createdAt }) : null;
