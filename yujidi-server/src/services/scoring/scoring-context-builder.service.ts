...
import type { AnalyzerRuntimeSnapshot } from "../trading/analyzer.service.js";
import {
  buildMarketResourceKey,
  sharedMarketSnapshotService,
  type MarketSnapshotService,
} from "../market-data/market-snapshot.service.js";
...
} from "../templates/template-monitoring-orchestrator.service.js";
import {
  sharedTemplateResourceResolver,
  type IndiaEquityScoringResources,
  type TemplateResourceResolverService,
} from "../templates/template-resource-resolver.service.js";
...
export class ScoringContextBuilderService {
  ...
  private async getRuntimeProvider(): Promise<RuntimeProvider> {
    ...
    const { sharedWebsocketManager } = await import("../trading/websocket.service.js");
