...
const templates: ScoringTemplateDefinition[] = [
  {
    ...
    maxScore: 100,
    sections: [
      section("MARKET_REGIME", "Market regime", 15, ["INDEX_VWAP_TREND_ALIGNMENT"], "PARTIAL"),
      section("SECTOR_STRENGTH", "Sector strength", 15, ["SECTOR_STRENGTH_CONTEXT"], "PARTIAL"),
      section("VWAP_LIQUIDITY", "VWAP and liquidity", 15, ["PRICE_VS_VWAP_CONTEXT", "VWAP_DISTANCE_CONTEXT"], "PARTIAL"),
      section("VOLUME_CONTEXT", "Volume context", 15, ["RVOL_CONTEXT", "LIQUIDITY_FRESHNESS_CONTEXT"], "PARTIAL"),
