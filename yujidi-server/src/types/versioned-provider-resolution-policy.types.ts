...
export type VersionedProviderResolutionPolicy = Readonly<{ definition: ValidatedProviderResolutionPolicy; compileEligible: boolean }>;
export type ProviderResolutionPolicyRegistration = Readonly<{ definition: ProviderResolutionPolicy; compileEligible: boolean }>;
